...
class DailyStockContextServiceTest {
        ...
        void processFinalizedOneMinuteCandle_shouldBuildOpeningRangeContext() {
                ...
                // Baseline cumulative volume at session minute 14 for opening-range
                // participation
                when(volumeTimeWindowBaselineRepository.findBySymbolAndExchangeAndTradingDateAndSessionMinute(
                                "ONGC",
                                "NSE",
                                tradingDate,
                                14)).thenReturn(Optional.of(
                                                VolumeTimeWindowBaseline.builder()
                                                                .symbol("ONGC")
                                                                .exchange("NSE")
                                                                .tradingDate(tradingDate)
                                                                .sessionMinute(14)
                                                                .avgCumulativeVolume20(2400L) // baseline slightly above
                                                                                              // twice the 1200 test
                                                                                              // volume
                                                                .sampleDays(20)
                                                                .computedAt(LocalDateTime.of(2026, 6, 24, 9, 30))
                                                                .build()));
