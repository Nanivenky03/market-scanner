...
# Save full response
$resp | Out-File -FilePath d:\projects\market-scanner\PHASE3_BASELINE_RESPONSE.json -Encoding UTF8

$json = $resp | ConvertFrom-Json

# Extract summary
Write-Host "=== PHASE 3: BASELINE 252-DAY RUN ==="
...
Write-Host ""
Write-Host "Baseline captured. Ready for determinism replay."
